...
const ContentWrapperLeft = ({TagLine, HeadingTitle, ImageAlt, ImagePath, CustomClass = "", BoxId, children})=>{
    return(
        <div className="w-full flex flex-col flex-col-reverse md:grid md:grid-cols-2 md:gap-x-[81px] mb-[120px] md:mb-[280px] relative z-[11]">
